...
### <a id="update-azps"></a><span data-ttu-id="0df5e-154">Atualizando para uma nova versão do Azure PowerShell</span><span class="sxs-lookup"><span data-stu-id="0df5e-154">Updating to a new version of Azure PowerShell</span></span>
