...
Examine o artigo [Instalar](install-azurerm-ps.md) para colocar o Azure PowerShell em funcionamento no sistema. Em seguida, leia o artigo de [Introdução](get-started-azureps.md) para começar a usá-lo. Para saber mais sobre a versão mais recente, veja as [notas de versão](release-notes-azureps.md).
