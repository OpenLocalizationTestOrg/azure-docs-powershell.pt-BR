...
Os módulos experimentais usam a seguinte convenção de nomenclatura:
...
Os módulos experimentais são publicados na Galeria do PowerShell como módulos existentes do Azure PowerShell. Para instalar o módulo experimental, use os seguintes comandos de uma sessão do PowerShell com privilégios elevados:
...
## <a name="try-using-the-experiments"></a>Tente usar os experimentos
