...
### <a id="update-azps"></a><span data-ttu-id="f27c9-149">Atualizando para uma nova versão do Azure PowerShell</span><span class="sxs-lookup"><span data-stu-id="f27c9-149">Updating to a new version of Azure PowerShell</span></span>
